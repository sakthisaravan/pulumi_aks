...
/** @ignore */ function getChildOpts(parent, opts) {
    return Object.assign(Object.assign({ parent: parent }, (opts === null || opts === void 0 ? void 0 : opts.version) && { version: opts.version }), (opts === null || opts === void 0 ? void 0 : opts.pluginDownloadURL) && { pluginDownloadURL: opts.pluginDownloadURL });
}
...
/** @ignore */ function getInvokeOpts(opts) {
    ...
    return {
        ...
        version: (_a = opts === null || opts === void 0 ? void 0 : opts.version) !== null && _a !== void 0 ? _a : (0, utilities_1.getVersion)(),
        pluginDownloadURL: opts === null || opts === void 0 ? void 0 : opts.pluginDownloadURL,
        async: true
    };
}
